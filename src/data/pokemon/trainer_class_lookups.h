const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_RS_BRENDAN]             = TRAINER_PIC_RS_BRENDAN_2,
    [FACILITY_CLASS_RS_MAY]                 = TRAINER_PIC_RS_MAY_2,
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_RS_BRENDAN]             = TRAINER_CLASS_PLAYER,
    [FACILITY_CLASS_RS_MAY]                 = TRAINER_CLASS_PLAYER,
    [FACILITY_CLASS_EM_BRENDAN]             = TRAINER_CLASS_PLAYER,
    [FACILITY_CLASS_EM_MAY]                 = TRAINER_CLASS_PLAYER,
