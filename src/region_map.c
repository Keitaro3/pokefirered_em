...
static const u8 *const sMapNames[] = {
    ...
    [MAPSEC_SAFARI_ZONE] = gMapSecName_SafariZone,
    ...
    [MAPSEC_UNDERWATER_SEAFLOOR_CAVERN] = gMapSecName_SeafloorCavern,
    [MAPSEC_VICTORY_ROAD] = gMapSecName_VictoryRoad,
    ...
    [MAPSEC_UNDERWATER_SEALED_CHAMBER] = gMapSecName_SealedChamber,
    ...
    [MAPSEC_BIRTH_ISLAND_EMERALD]      = gMapSecName_BirthIsland,
    ...
    [MAPSEC_UNDERWATER_105]            = gMapSecName_Underwater,
    ...
    [MAPSEC_ALTERING_CAVE_EMERALD]     = gMapSecName_AlteringCave,
    [MAPSEC_NAVEL_ROCK_EMERALD]        = gMapSecName_NavelRock,
    [MAPSEC_TRAINER_HILL]              = gMapSecName_TrainerHill
};

// Orre location data
static const u8 *const sColosseumMapNames[] = {
    [MAPSEC_DISTANT_LAND]              = gMapSecName_DistantLand,
    [MAPSEC_OUTSKIRT_STAND_1]          = gMapSecName_OutskirtStand,
    [MAPSEC_OUTSKIRT_STAND_2]          = gMapSecName_OutskirtStand,
    [MAPSEC_PHENAC_CITY_1]             = gMapSecName_PhenacCity,
    [MAPSEC_PHENAC_CITY_2]             = gMapSecName_PhenacCity,
    [MAPSEC_MAYORS_HOUSE_1]            = gMapSecName_MayorsHouse,
    [MAPSEC_MAYORS_HOUSE_2]            = gMapSecName_MayorsHouse,
    [MAPSEC_ORRE_07]            	   = gMapSecName_PhenacCity,
    [MAPSEC_CIPHER_LAB_1]              = gMapSecName_PhenacCity,
    [MAPSEC_CIPHER_LAB_2]              = gMapSecName_PhenacCity,
    [MAPSEC_CIPHER_LAB_3]              = gMapSecName_PhenacCity,
    [MAPSEC_CIPHER_LAB_4]              = gMapSecName_PreGym,
    [MAPSEC_ORRE_0C]             	   = gMapSecName_PreGym,
    [MAPSEC_ORRE_0D]             	   = gMapSecName_PhenacStadium,
    [MAPSEC_ORRE_0E]           		   = gMapSecName_PhenacStadium,
    [MAPSEC_PYRITE_TOWN_1]             = gMapSecName_PyriteTown,
    [MAPSEC_ORRE_10]                   = gMapSecName_PyriteTown,
    [MAPSEC_ORRE_11]                   = gMapSecName_PyriteTown,
    [MAPSEC_ORRE_12]                   = gMapSecName_PyriteTown,
    [MAPSEC_ORRE_13]                   = gMapSecName_PyriteTown,
    [MAPSEC_ORRE_14]                   = gMapSecName_PyriteTown,
    [MAPSEC_ORRE_15]                   = gMapSecName_PyriteTown,
    [MAPSEC_ORRE_16]                   = gMapSecName_PyriteTown,
    [MAPSEC_ORRE_17]                   = gMapSecName_PyriteTown,
    [MAPSEC_ORRE_18]                   = gMapSecName_PyriteTown,
    [MAPSEC_PYRITE_BLDG_1]             = gMapSecName_PyriteBldg,
    [MAPSEC_ORRE_1A]                   = gMapSecName_PyriteBldg,
    [MAPSEC_ORRE_1B]                   = gMapSecName_PyriteBldg,
    [MAPSEC_PYRITE_BLDG_2]             = gMapSecName_PyriteBldg,
    [MAPSEC_PYRITE_CAVE_1]             = gMapSecName_PyriteCave,
    [MAPSEC_MIRORS_HIDEOUT]            = gMapSecName_MirorsHideout,
    [MAPSEC_PYRITE_CAVE_2]             = gMapSecName_PyriteCave,
    [MAPSEC_PYRITE_CAVE_3]             = gMapSecName_PyriteCave,
    [MAPSEC_ORRE_21]                   = gMapSecName_PyriteCave,
    [MAPSEC_ORRE_22]                   = gMapSecName_PyriteCave,
    [MAPSEC_ORRE_23]                   = gMapSecName_PyriteColosseum,
    [MAPSEC_ORRE_24]                   = gMapSecName_AgateVillage,
    [MAPSEC_ORRE_25]                   = gMapSecName_RelicCave,
    [MAPSEC_ORRE_26]                   = gMapSecName_RelicCave,
    [MAPSEC_AGATE_VILLAGE]             = gMapSecName_AgateVillage,
    [MAPSEC_ORRE_28]                   = gMapSecName_AgateVillage,
    [MAPSEC_ORRE_29]                   = gMapSecName_AgateVillage,
    [MAPSEC_ORRE_2A]                   = gMapSecName_AgateVillage,
    [MAPSEC_ORRE_2B]                   = gMapSecName_AgateVillage,
    [MAPSEC_ORRE_2C]                   = gMapSecName_AgateVillage,
    [MAPSEC_TOWER_COLOSSEUM_1]         = gMapSecName_AgateVillage,
    [MAPSEC_ORRE_2E]                   = gMapSecName_AgateVillage,
    [MAPSEC_THE_UNDER_1]               = gMapSecName_TheUnder,
    [MAPSEC_ORRE_30]                   = gMapSecName_TheUnder,
    [MAPSEC_ORRE_31]                   = gMapSecName_TheUnder,
    [MAPSEC_ORRE_32]                   = gMapSecName_TheUnder,
    [MAPSEC_ORRE_33]                   = gMapSecName_TheUnder,
    [MAPSEC_ORRE_34]                   = gMapSecName_TheUnder,
    [MAPSEC_ORRE_35]                   = gMapSecName_TheUnder,
    [MAPSEC_ORRE_36]     		       = gMapSecName_TheUnder,
    [MAPSEC_THE_UNDER_2]               = gMapSecName_TheUnder,
    [MAPSEC_ORRE_38]                   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_39]                   = gMapSecName_TheUnderSubway,
    [MAPSEC_THE_UNDER_SUBWAY]          = gMapSecName_TheUnderSubway,
    [MAPSEC_REALGAM_TOWER_1]           = gMapSecName_TheUnderSubway,
    [MAPSEC_ORRE_3C]            	   = gMapSecName_TheUnderSubway,
    [MAPSEC_ORRE_3D]                   = gMapSecName_TheUnderSubway,
    [MAPSEC_ORRE_3E]                   = gMapSecName_TheUnder,
    [MAPSEC_ORRE_3F]                   = gMapSecName_UnderColosseum,
    [MAPSEC_CIPHER_KEY_LAIR_1]         = gMapSecName_DeepColosseum,
    [MAPSEC_CIPHER_KEY_LAIR_2]         = gMapSecName_FrontOfLab,
    [MAPSEC_CIPHER_KEY_LAIR_3]         = gMapSecName_Laboratory,
    [MAPSEC_ORRE_MULTI_USE_43]         = gMapSecName_Laboratory,
    [MAPSEC_LABORATORY_1]              = gMapSecName_Laboratory,
    [MAPSEC_LABORATORY_2]      		   = gMapSecName_Laboratory,
    [MAPSEC_CIPHER_KEY_LAIR_4]         = gMapSecName_Laboratory,
    [MAPSEC_CIPHER_KEY_LAIR_5]         = gMapSecName_Laboratory,
    [MAPSEC_ORRE_48]                   = gMapSecName_Laboratory,
    [MAPSEC_CITADARK_ISLE_1]           = gMapSecName_Laboratory,
    [MAPSEC_CITADARK_ISLE_2]           = gMapSecName_MtBattle,
    [MAPSEC_CITADARK_ISLE_3]           = gMapSecName_MtBattle,
    [MAPSEC_ORRE_MULTI_USE_4C]         = gMapSecName_MtBattle,
    [MAPSEC_CITADARK_ISLE_4]           = gMapSecName_MtBattle,
    [MAPSEC_ORRE_4E]                   = gMapSecName_MtBattle,
    [MAPSEC_ORRE_4F] 			       = gMapSecName_MtBattle,
    [MAPSEC_CITADARK_ISLE_5]           = gMapSecName_MtBattle,
    [MAPSEC_CITADARK_ISLE_6]           = gMapSecName_MtBattle,
    [MAPSEC_ORRE_52]                   = gMapSecName_MtBattle,
    [MAPSEC_ORRE_53]                   = gMapSecName_MtBattle,
    [MAPSEC_CITADARK_ISLE_7]  	       = gMapSecName_MtBattle,
    [MAPSEC_CITADARK_ISLE_8]           = gMapSecName_MtBattle,
    [MAPSEC_ORRE_56]                   = gMapSecName_MtBattle,
    [MAPSEC_CITADARK_ISLE_9]           = gMapSecName_MtBattle,
    [MAPSEC_CITADARK_ISLE_10]          = gMapSecName_MtBattle,
    [MAPSEC_ORRE_59]                   = gMapSecName_MtBattle,
    [MAPSEC_ROCK]               	   = gMapSecName_MtBattle,
    [MAPSEC_OASIS]             		   = gMapSecName_MtBattle,
    [MAPSEC_CAVE]             		   = gMapSecName_MtBattle,
    [MAPSEC_ORRE_5D]            	   = gMapSecName_MtBattle,
    [MAPSEC_PHENAC_CITY_3]             = gMapSecName_MtBattle,
    [MAPSEC_ORRE_5F]                   = gMapSecName_MtBtlColosseum,
    [MAPSEC_PHENAC_CITY_4]             = gMapSecName_DistantLand,
    [MAPSEC_PHENAC_CITY_5]             = gMapSecName_DistantLand,
    [MAPSEC_ORRE_62]              	   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_63]            	   = gMapSecName_DistantLand,
    [MAPSEC_PHENAC_CITY_6]             = gMapSecName_DistantLand,
    [MAPSEC_ORRE_65]                   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_66]                   = gMapSecName_RealgamTower,
    [MAPSEC_ORRE_67]                   = gMapSecName_RealgamtwrDome,
    [MAPSEC_REALGAM_TOWER_2]           = gMapSecName_RealgamtwrDome,
    [MAPSEC_ORRE_69]                   = gMapSecName_RealgamtwrDome,
    [MAPSEC_REALGAM_TOWER_3]           = gMapSecName_RealgamtwrDome,
    [MAPSEC_PHENAC_CITY_7]             = gMapSecName_RealgamtwrDome,
    [MAPSEC_ORRE_6C]                   = gMapSecName_RealgamtwrDome,
    [MAPSEC_ORRE_MULTI_USE_6D]         = gMapSecName_RealgamtwrDome,
    [MAPSEC_ORRE_MULTI_USE_6E]         = gMapSecName_RealgamtwrDome,
    [MAPSEC_ORRE_MULTI_USE_6F]         = gMapSecName_RealgamtwrDome,
    [MAPSEC_PYRITE_COLOSSEUM]          = gMapSecName_RealgamtwrDome,
    [MAPSEC_ORRE_71]                   = gMapSecName_RealgamtwrDome,
    [MAPSEC_ORRE_72]                   = gMapSecName_RealgamtwrLobby,
    [MAPSEC_REALGAM_TOWER_4]           = gMapSecName_RealgamTower,
    [MAPSEC_ORRE_74]                   = gMapSecName_RealgamTower,
    [MAPSEC_REALGAM_TOWER_5]           = gMapSecName_RealgamTower,
    [MAPSEC_TOWER_COLOSSEUM_2]         = gMapSecName_TowerColosseum,
    [MAPSEC_PYRITE_TOWN_2]             = gMapSecName_PhenacCity,
    [MAPSEC_ORRE_78]                   = gMapSecName_PyriteColosseum,
    [MAPSEC_ORRE_79]                   = gMapSecName_UnderColosseum,
    [MAPSEC_ORRE_7A]                   = gMapSecName_TheUnder,
    [MAPSEC_ORRE_7B]                   = gMapSecName_RealgamTower,
    [MAPSEC_ORRE_7C]                   = gMapSecName_RealgamTower,
    [MAPSEC_DEEP_COLOSSEUM]            = gMapSecName_DeepColosseum,
    [MAPSEC_ORRE_7E]           		   = gMapSecName_OrreColosseum,
    [MAPSEC_ORRE_7F]                   = gMapSecName_TheUnder,
    [MAPSEC_PHENAC_CITY_8]             = gMapSecName_PhenacCity,
    [MAPSEC_ORRE_81]          		   = gMapSecName_SnagemHideout,
    [MAPSEC_ORRE_82]        		   = gMapSecName_SnagemHideout,
    [MAPSEC_ORRE_83]             	   = gMapSecName_SnagemHideout,
    [MAPSEC_SNAGEM_HIDEOUT_1]          = gMapSecName_SnagemHideout,
    [MAPSEC_ORRE_85]            	   = gMapSecName_SnagemHideout,
    [MAPSEC_SNAGEM_HIDEOUT_2]          = gMapSecName_SnagemHideout,
    [MAPSEC_ORRE_87]           		   = gMapSecName_SnagemHideout,
    [MAPSEC_ORRE_88]         		   = gMapSecName_SnagemHideout,
    [MAPSEC_ORRE_89]            	   = gMapSecName_SnagemHideout,
    [MAPSEC_ORRE_8A]               	   = gMapSecName_TheUnderSubway,
    [MAPSEC_ORRE_8B]           		   = gMapSecName_TheUnderSubway,
    [MAPSEC_ORRE_8C]             	   = gMapSecName_Laboratory,
    [MAPSEC_ORRE_8D]             	   = gMapSecName_Laboratory,
    [MAPSEC_ORRE_8E]               	   = gMapSecName_PyriteColosseum,
    [MAPSEC_POKEMON_HQ_LAB]            = gMapSecName_PokemonHQLab,
    [MAPSEC_ORRE_90]                   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_91]                   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_92]                   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_93]                   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_94]                   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_95]                   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_96]                   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_97]                   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_98]                   = gMapSecName_DistantLand,
    [MAPSEC_GATEON_PORT_1]             = gMapSecName_DistantLand,
    [MAPSEC_ORRE_9A]           		   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_9B]                   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_9C]                   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_9D]                   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_9E]            	   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_9F]           		   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_A0]           		   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_A1]          		   = gMapSecName_DistantLand,
    [MAPSEC_GATEON_PORT_2]             = gMapSecName_DistantLand,
    [MAPSEC_ORRE_A3]            	   = gMapSecName_DistantLand,
    [MAPSEC_OUTSKIRT_STAND_3]          = gMapSecName_DistantLand,
	[MAPSEC_ORRE_A5]            	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_A6]            	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_A7]            	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_A8]            	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_A9]            	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_AA]            	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_AB]            	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_AC]            	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_AD]            	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_AE]            	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_AF]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_B0]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_B1]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_B2]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_B3]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_B4]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_B5]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_B6]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_B7]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_B8]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_B9]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_BA]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_BB]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_BC]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_BD]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_BE]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_BF]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_C0]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_C1]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_C2]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_C3]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_C4]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_C5]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_C6]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_C7]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_C8]               	   = gMapSecName_OutskirtStand,
	[MAPSEC_ORRE_C9]               	   = gMapSecName_SnagemHideout,
	[MAPSEC_ORRE_CA]               	   = gMapSecName_PhenacCity,
	[MAPSEC_ORRE_CB]               	   = gMapSecName_PreGym,
	[MAPSEC_ORRE_CC]               	   = gMapSecName_MayorsHouse,
	[MAPSEC_ORRE_CD]               	   = gMapSecName_PyriteTown,
	[MAPSEC_ORRE_CE]               	   = gMapSecName_PyriteCave,
	[MAPSEC_ORRE_CF]               	   = gMapSecName_PyriteBldg,
	[MAPSEC_ORRE_D0]               	   = gMapSecName_AgateVillage,
	[MAPSEC_ORRE_D1]               	   = gMapSecName_AgateVillage,
	[MAPSEC_ORRE_D2]               	   = gMapSecName_RelicCave,
	[MAPSEC_ORRE_D3]               	   = gMapSecName_TheUnder,
	[MAPSEC_ORRE_D4]               	   = gMapSecName_TheUnder,
	[MAPSEC_ORRE_D5]               	   = gMapSecName_TheUnderSubway,
	[MAPSEC_ORRE_D6]               	   = gMapSecName_FrontOfLab,
	[MAPSEC_ORRE_D7]               	   = gMapSecName_Laboratory,
	[MAPSEC_ORRE_D8]               	   = gMapSecName_MtBattle,
	[MAPSEC_ORRE_D9]               	   = gMapSecName_MtBattle,
	[MAPSEC_ORRE_DA]               	   = gMapSecName_MtBattle,
	[MAPSEC_ORRE_DB]               	   = gMapSecName_MtBattle,
	[MAPSEC_ORRE_DC]               	   = gMapSecName_MtBattle,
	[MAPSEC_ORRE_DD]               	   = gMapSecName_RealgamtwrDome,
	[MAPSEC_ORRE_DE]               	   = gMapSecName_RealgamtwrLobby,
	[MAPSEC_ORRE_DF]               	   = gMapSecName_RealgamTower,
	[MAPSEC_ORRE_E0]               	   = gMapSecName_RealgamTower,
	[MAPSEC_ORRE_E1]               	   = gMapSecName_RealgamTower2F,
	[MAPSEC_ORRE_E2]               	   = gMapSecName_RealgamTower2F,
	[MAPSEC_ORRE_E3]               	   = gMapSecName_TowerColosseum,
	[MAPSEC_ORRE_E4]               	   = gMapSecName_MtBtlColosseum
};

static const u8 *const sGaleOfDarknessMapNames[] = {
    [MAPSEC_DISTANT_LAND]              = gMapSecName_DistantLand,
    [MAPSEC_OUTSKIRT_STAND_1]          = gMapSecName_CipherLab,
    [MAPSEC_OUTSKIRT_STAND_2]          = gMapSecName_DistantLand,
    [MAPSEC_PHENAC_CITY_1]             = gMapSecName_DistantLand,
    [MAPSEC_PHENAC_CITY_2]             = gMapSecName_DistantLand,
    [MAPSEC_MAYORS_HOUSE_1]            = gMapSecName_DistantLand,
    [MAPSEC_MAYORS_HOUSE_2]            = gMapSecName_DistantLand,
    [MAPSEC_ORRE_07]            	   = gMapSecName_CipherLab,
    [MAPSEC_CIPHER_LAB_1]              = gMapSecName_CipherLab,
    [MAPSEC_CIPHER_LAB_2]              = gMapSecName_CipherLab,
    [MAPSEC_CIPHER_LAB_3]              = gMapSecName_CipherLab,
    [MAPSEC_CIPHER_LAB_4]              = gMapSecName_CipherLab,
    [MAPSEC_ORRE_0C]             	   = gMapSecName_MtBattle,
    [MAPSEC_ORRE_0D]             	   = gMapSecName_MtBattle,
    [MAPSEC_ORRE_0E]           		   = gMapSecName_MtBattle,
    [MAPSEC_PYRITE_TOWN_1]             = gMapSecName_MtBattle,
    [MAPSEC_ORRE_10]                   = gMapSecName_MtBattle,
    [MAPSEC_ORRE_11]                   = gMapSecName_MtBattle,
    [MAPSEC_ORRE_12]                   = gMapSecName_MtBattle,
    [MAPSEC_ORRE_13]                   = gMapSecName_MtBattle,
    [MAPSEC_ORRE_14]                   = gMapSecName_MtBattle,
    [MAPSEC_ORRE_15]                   = gMapSecName_MtBattle,
    [MAPSEC_ORRE_16]                   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_17]                   = gMapSecName_MtBattle,
    [MAPSEC_ORRE_18]                   = gMapSecName_MtBattle,
    [MAPSEC_PYRITE_BLDG_1]             = gMapSecName_MtBattle,
    [MAPSEC_ORRE_1A]                   = gMapSecName_MtBattle,
    [MAPSEC_ORRE_1B]                   = gMapSecName_MtBattle,
    [MAPSEC_PYRITE_BLDG_2]             = gMapSecName_MtBattle,
    [MAPSEC_PYRITE_CAVE_1]             = gMapSecName_MtBattle,
    [MAPSEC_MIRORS_HIDEOUT]            = gMapSecName_MtBattle,
    [MAPSEC_PYRITE_CAVE_2]             = gMapSecName_MtBattle,
    [MAPSEC_PYRITE_CAVE_3]             = gMapSecName_MtBattle,
    [MAPSEC_ORRE_21]                   = gMapSecName_MtBattle,
    [MAPSEC_ORRE_22]                   = gMapSecName_MtBattle,
    [MAPSEC_ORRE_23]                   = gMapSecName_SSLibra,
    [MAPSEC_ORRE_24]                   = gMapSecName_SSLibra,
    [MAPSEC_ORRE_25]                   = gMapSecName_SSLibra,
    [MAPSEC_ORRE_26]                   = gMapSecName_SSLibra,
    [MAPSEC_AGATE_VILLAGE]             = gMapSecName_SSLibra,
    [MAPSEC_ORRE_28]                   = gMapSecName_SSLibra,
    [MAPSEC_ORRE_29]                   = gMapSecName_SSLibra,
    [MAPSEC_ORRE_2A]                   = gMapSecName_SSLibra,
    [MAPSEC_ORRE_2B]                   = gMapSecName_SSLibra,
    [MAPSEC_ORRE_2C]                   = gMapSecName_SSLibra,
    [MAPSEC_TOWER_COLOSSEUM_1]         = gMapSecName_RealgamTower,
    [MAPSEC_ORRE_2E]                   = gMapSecName_RealgamTower,
    [MAPSEC_THE_UNDER_1]               = gMapSecName_DistantLand,
    [MAPSEC_ORRE_30]                   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_31]                   = gMapSecName_RealgamTower,
    [MAPSEC_ORRE_32]                   = gMapSecName_RealgamTower,
    [MAPSEC_ORRE_33]                   = gMapSecName_RealgamTower,
    [MAPSEC_ORRE_34]                   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_35]                   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_36]     		       = gMapSecName_DistantLand,
    [MAPSEC_THE_UNDER_2]               = gMapSecName_DistantLand,
    [MAPSEC_ORRE_38]                   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_39]                   = gMapSecName_RealgamTower,
    [MAPSEC_THE_UNDER_SUBWAY]          = gMapSecName_RealgamTower,
    [MAPSEC_REALGAM_TOWER_1]           = gMapSecName_RealgamTower,
    [MAPSEC_ORRE_3C]            	   = gMapSecName_RealgamTower,
    [MAPSEC_ORRE_3D]                   = gMapSecName_RealgamTower,
    [MAPSEC_ORRE_3E]                   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_3F]                   = gMapSecName_DistantLand,
    [MAPSEC_CIPHER_KEY_LAIR_1]         = gMapSecName_CipherKeyLair,
    [MAPSEC_CIPHER_KEY_LAIR_2]         = gMapSecName_CipherKeyLair,
    [MAPSEC_CIPHER_KEY_LAIR_3]         = gMapSecName_CipherKeyLair,
    [MAPSEC_ORRE_MULTI_USE_43]         = gMapSecName_CipherKeyLair,
    [MAPSEC_LABORATORY_1]              = gMapSecName_CipherKeyLair,
    [MAPSEC_LABORATORY_2]      		   = gMapSecName_CipherKeyLair,
    [MAPSEC_CIPHER_KEY_LAIR_4]         = gMapSecName_CipherKeyLair,
    [MAPSEC_CIPHER_KEY_LAIR_5]         = gMapSecName_CipherKeyLair,
    [MAPSEC_ORRE_48]                   = gMapSecName_CitadarkIsle,
    [MAPSEC_CITADARK_ISLE_1]           = gMapSecName_CitadarkIsle,
    [MAPSEC_CITADARK_ISLE_2]           = gMapSecName_CitadarkIsle,
    [MAPSEC_CITADARK_ISLE_3]           = gMapSecName_CitadarkIsle,
    [MAPSEC_ORRE_MULTI_USE_4C]         = gMapSecName_CitadarkIsle,
    [MAPSEC_CITADARK_ISLE_4]           = gMapSecName_CitadarkIsle,
    [MAPSEC_ORRE_4E]                   = gMapSecName_CitadarkIsle,
    [MAPSEC_ORRE_4F] 			       = gMapSecName_CitadarkIsle,
    [MAPSEC_CITADARK_ISLE_5]           = gMapSecName_CitadarkIsle,
    [MAPSEC_CITADARK_ISLE_6]           = gMapSecName_CitadarkIsle,
    [MAPSEC_ORRE_52]                   = gMapSecName_CitadarkIsle,
    [MAPSEC_ORRE_53]                   = gMapSecName_CitadarkIsle,
    [MAPSEC_CITADARK_ISLE_7]  	       = gMapSecName_CitadarkIsle,
    [MAPSEC_CITADARK_ISLE_8]           = gMapSecName_CitadarkIsle,
    [MAPSEC_ORRE_56]                   = gMapSecName_CitadarkIsle,
    [MAPSEC_CITADARK_ISLE_9]           = gMapSecName_CitadarkIsle,
    [MAPSEC_CITADARK_ISLE_10]          = gMapSecName_CitadarkIsle,
    [MAPSEC_ORRE_59]                   = gMapSecName_CitadarkIsle,
    [MAPSEC_ROCK]               	   = gMapSecName_Rock,
    [MAPSEC_OASIS]             		   = gMapSecName_Oasis,
    [MAPSEC_CAVE]             		   = gMapSecName_Cave,
    [MAPSEC_ORRE_5D]            	   = gMapSecName_PhenacCity,
    [MAPSEC_PHENAC_CITY_3]             = gMapSecName_PhenacCity,
    [MAPSEC_ORRE_5F]                   = gMapSecName_PhenacCity,
    [MAPSEC_PHENAC_CITY_4]             = gMapSecName_PhenacCity,
    [MAPSEC_PHENAC_CITY_5]             = gMapSecName_PhenacCity,
    [MAPSEC_ORRE_62]              	   = gMapSecName_PhenacCity,
    [MAPSEC_ORRE_63]            	   = gMapSecName_PhenacCity,
    [MAPSEC_PHENAC_CITY_6]             = gMapSecName_PhenacCity,
    [MAPSEC_ORRE_65]                   = gMapSecName_PhenacCity,
    [MAPSEC_ORRE_66]                   = gMapSecName_PhenacCity,
    [MAPSEC_ORRE_67]                   = gMapSecName_PhenacCity,
    [MAPSEC_REALGAM_TOWER_2]           = gMapSecName_PhenacCity,
    [MAPSEC_ORRE_69]                   = gMapSecName_PhenacCity,
    [MAPSEC_REALGAM_TOWER_3]           = gMapSecName_PhenacCity,
    [MAPSEC_PHENAC_CITY_7]             = gMapSecName_PhenacCity,
    [MAPSEC_ORRE_6C]                   = gMapSecName_PyriteTown,
    [MAPSEC_ORRE_MULTI_USE_6D]         = gMapSecName_PyriteTown,
    [MAPSEC_ORRE_MULTI_USE_6E]         = gMapSecName_PyriteTown,
    [MAPSEC_ORRE_MULTI_USE_6F]         = gMapSecName_PyriteTown,
    [MAPSEC_PYRITE_COLOSSEUM]          = gMapSecName_PyriteTown,
    [MAPSEC_ORRE_71]                   = gMapSecName_PyriteTown,
    [MAPSEC_ORRE_72]                   = gMapSecName_DistantLand,
    [MAPSEC_REALGAM_TOWER_4]           = gMapSecName_PyriteTown,
    [MAPSEC_ORRE_74]                   = gMapSecName_PyriteTown,
    [MAPSEC_REALGAM_TOWER_5]           = gMapSecName_PyriteTown,
    [MAPSEC_TOWER_COLOSSEUM_2]         = gMapSecName_PyriteTown,
    [MAPSEC_PYRITE_TOWN_2]             = gMapSecName_PyriteTown,
    [MAPSEC_ORRE_78]                   = gMapSecName_PyriteTown,
    [MAPSEC_ORRE_79]                   = gMapSecName_PyriteTown,
    [MAPSEC_ORRE_7A]                   = gMapSecName_PyriteTown,
    [MAPSEC_ORRE_7B]                   = gMapSecName_PyriteTown,
    [MAPSEC_ORRE_7C]                   = gMapSecName_DistantLand,
    [MAPSEC_DEEP_COLOSSEUM]            = gMapSecName_AgateVillage,
    [MAPSEC_ORRE_7E]           		   = gMapSecName_AgateVillage,
    [MAPSEC_ORRE_7F]                   = gMapSecName_AgateVillage,
    [MAPSEC_PHENAC_CITY_8]             = gMapSecName_AgateVillage,
    [MAPSEC_ORRE_81]          		   = gMapSecName_AgateVillage,
    [MAPSEC_ORRE_82]        		   = gMapSecName_AgateVillage,
    [MAPSEC_ORRE_83]             	   = gMapSecName_AgateVillage,
    [MAPSEC_SNAGEM_HIDEOUT_1]          = gMapSecName_AgateVillage,
    [MAPSEC_ORRE_85]            	   = gMapSecName_AgateVillage,
    [MAPSEC_SNAGEM_HIDEOUT_2]          = gMapSecName_AgateVillage,
    [MAPSEC_ORRE_87]           		   = gMapSecName_AgateVillage,
    [MAPSEC_ORRE_88]         		   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_89]            	   = gMapSecName_DistantLand,
    [MAPSEC_ORRE_8A]               	   = gMapSecName_PokemonHQLab,
    [MAPSEC_ORRE_8B]           		   = gMapSecName_PokemonHQLab,
    [MAPSEC_ORRE_8C]             	   = gMapSecName_PokemonHQLab,
    [MAPSEC_ORRE_8D]             	   = gMapSecName_PokemonHQLab,
    [MAPSEC_ORRE_8E]               	   = gMapSecName_PokemonHQLab,
    [MAPSEC_POKEMON_HQ_LAB]            = gMapSecName_PokemonHQLab,
    [MAPSEC_ORRE_90]                   = gMapSecName_GateonPort,
    [MAPSEC_ORRE_91]                   = gMapSecName_GateonPort,
    [MAPSEC_ORRE_92]                   = gMapSecName_GateonPort,
    [MAPSEC_ORRE_93]                   = gMapSecName_GateonPort,
    [MAPSEC_ORRE_94]                   = gMapSecName_GateonPort,
    [MAPSEC_ORRE_95]                   = gMapSecName_GateonPort,
    [MAPSEC_ORRE_96]                   = gMapSecName_GateonPort,
    [MAPSEC_ORRE_97]                   = gMapSecName_GateonPort,
    [MAPSEC_ORRE_98]                   = gMapSecName_GateonPort,
    [MAPSEC_GATEON_PORT_1]             = gMapSecName_GateonPort,
    [MAPSEC_ORRE_9A]           		   = gMapSecName_GateonPort,
    [MAPSEC_ORRE_9B]                   = gMapSecName_GateonPort,
    [MAPSEC_ORRE_9C]                   = gMapSecName_GateonPort,
    [MAPSEC_ORRE_9D]                   = gMapSecName_GateonPort,
    [MAPSEC_ORRE_9E]            	   = gMapSecName_GateonPort,
    [MAPSEC_ORRE_9F]           		   = gMapSecName_GateonPort,
    [MAPSEC_ORRE_A0]           		   = gMapSecName_GateonPort,
    [MAPSEC_ORRE_A1]          		   = gMapSecName_GateonPort,
    [MAPSEC_GATEON_PORT_2]             = gMapSecName_GateonPort,
    [MAPSEC_ORRE_A3]            	   = gMapSecName_OutskirtStand,
    [MAPSEC_OUTSKIRT_STAND_3]          = gMapSecName_OutskirtStand,
	[MAPSEC_ORRE_A5]            	   = gMapSecName_SnagemHideout,
	[MAPSEC_ORRE_A6]            	   = gMapSecName_SnagemHideout,
	[MAPSEC_ORRE_A7]            	   = gMapSecName_SnagemHideout,
	[MAPSEC_ORRE_A8]            	   = gMapSecName_SnagemHideout,
	[MAPSEC_ORRE_A9]            	   = gMapSecName_KaminkosHouse,
	[MAPSEC_ORRE_AA]            	   = gMapSecName_KaminkosHouse,
	[MAPSEC_ORRE_AB]            	   = gMapSecName_KaminkosHouse,
	[MAPSEC_ORRE_AC]            	   = gMapSecName_KaminkosHouse,
	[MAPSEC_ORRE_AD]            	   = gMapSecName_KaminkosHouse,
	[MAPSEC_ORRE_AE]            	   = gMapSecName_OrreColosseum,
	[MAPSEC_ORRE_AF]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_B0]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_B1]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_B2]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_B3]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_B4]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_B5]               	   = gMapSecName_PhenacCity,
	[MAPSEC_ORRE_B6]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_B7]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_B8]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_B9]               	   = gMapSecName_DistantLand,
	...
	[MAPSEC_ORRE_C6]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_C7]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_C8]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_C9]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_CA]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_CB]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_CC]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_CD]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_CE]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_CF]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_D0]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_D1]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_D2]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_D3]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_D4]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_D5]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_D6]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_D7]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_D8]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_D9]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_DA]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_DB]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_DC]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_DD]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_DE]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_DF]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_E0]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_E1]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_E2]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_E3]               	   = gMapSecName_DistantLand,
	[MAPSEC_ORRE_E4]               	   = gMapSecName_DistantLand
};

static const u8 *const sJohtoMapNames[] = {
	[MAPSEC_NEW_BARK_TOWN]             = gMapSecName_NewBarkTown,
	[MAPSEC_CHERRYGROVE_CITY]          = gMapSecName_CherrygroveCity,
	[MAPSEC_VIOLET_CITY]               = gMapSecName_VioletCity,
	[MAPSEC_AZALEA_TOWN]               = gMapSecName_AzaleaTown,
	[MAPSEC_CIANWOOD_CITY]             = gMapSecName_CianwoodCity,
	[MAPSEC_GOLDENROD_CITY]            = gMapSecName_GoldenrodCity,
	[MAPSEC_OLIVINE_CITY]              = gMapSecName_OlivineCity,
	[MAPSEC_ECRUTEAK_CITY]             = gMapSecName_EcruteakCity,
	[MAPSEC_MAHOGANY_TOWN]             = gMapSecName_MahoganyTown,
	[MAPSEC_LAKE_OF_RAGE]              = gMapSecName_LakeOfRage,
	[MAPSEC_BLACKTHORN_CITY]           = gMapSecName_BlackthornCity,
	[MAPSEC_MT_SILVER]                 = gMapSecName_MtSilver,	
    [MAPSEC_PALLET_TOWN_GS]            = gMapSecName_PalletTown,
    [MAPSEC_VIRIDIAN_CITY_GS]          = gMapSecName_ViridianCity,
    [MAPSEC_PEWTER_CITY_GS]            = gMapSecName_PewterCity,
    [MAPSEC_CERULEAN_CITY_GS]          = gMapSecName_CeruleanCity,
    [MAPSEC_LAVENDER_TOWN_GS]          = gMapSecName_LavenderTown,
    [MAPSEC_VERMILION_CITY_GS]         = gMapSecName_VermilionCity,
    [MAPSEC_CELADON_CITY_GS]           = gMapSecName_CeladonCity,
    [MAPSEC_FUCHSIA_CITY_GS]           = gMapSecName_FuchsiaCity,
    [MAPSEC_CINNABAR_ISLAND_GS]        = gMapSecName_CinnabarIsland,
    [MAPSEC_INDIGO_PLATEAU_GS]         = gMapSecName_IndigoPlateau,
    [MAPSEC_SAFFRON_CITY_GS]           = gMapSecName_SaffronCity,
    [MAPSEC_ROUTE_4_FLYDUP_GS]         = gMapSecName_Route4,
    [MAPSEC_ROUTE_10_FLYDUP_GS]        = gMapSecName_Route10,
    [MAPSEC_ROUTE_1_GS]                = gMapSecName_Route1,
    [MAPSEC_ROUTE_2_GS]                = gMapSecName_Route2,
    [MAPSEC_ROUTE_3_GS]                = gMapSecName_Route3,
    [MAPSEC_ROUTE_4_GS]                = gMapSecName_Route4_2,
    [MAPSEC_ROUTE_5_GS]                = gMapSecName_Route5,
    [MAPSEC_ROUTE_6_GS]                = gMapSecName_Route6,
    [MAPSEC_ROUTE_7_GS]                = gMapSecName_Route7,
    [MAPSEC_ROUTE_8_GS]                = gMapSecName_Route8,
    [MAPSEC_ROUTE_9_GS]                = gMapSecName_Route9,
    [MAPSEC_ROUTE_10_GS]               = gMapSecName_Route10_2,
    [MAPSEC_ROUTE_11_GS]               = gMapSecName_Route11,
    [MAPSEC_ROUTE_12_GS]               = gMapSecName_Route12,
    [MAPSEC_ROUTE_13_GS]               = gMapSecName_Route13,
    [MAPSEC_ROUTE_14_GS]               = gMapSecName_Route14,
    [MAPSEC_ROUTE_15_GS]               = gMapSecName_Route15,
    [MAPSEC_ROUTE_16_GS]               = gMapSecName_Route16,
    [MAPSEC_ROUTE_17_GS]               = gMapSecName_Route17,
    [MAPSEC_ROUTE_18_GS]               = gMapSecName_Route18,
    [MAPSEC_ROUTE_19_GS]               = gMapSecName_Route19,
    [MAPSEC_ROUTE_20_GS]               = gMapSecName_Route20,
    [MAPSEC_ROUTE_21_GS]               = gMapSecName_Route21,
    [MAPSEC_ROUTE_22_GS]               = gMapSecName_Route22,
    [MAPSEC_ROUTE_23_GS]               = gMapSecName_Route23,
    [MAPSEC_ROUTE_24_GS]               = gMapSecName_Route24,
    [MAPSEC_ROUTE_25_GS]               = gMapSecName_Route25,
	[MAPSEC_ROUTE_26]                  = gMapSecName_Route26,
	[MAPSEC_ROUTE_27]                  = gMapSecName_Route27,
	[MAPSEC_ROUTE_28]                  = gMapSecName_Route28,
	[MAPSEC_ROUTE_29]                  = gMapSecName_Route29,
	[MAPSEC_ROUTE_30]                  = gMapSecName_Route30,
	[MAPSEC_ROUTE_31]                  = gMapSecName_Route31,
	[MAPSEC_ROUTE_32]                  = gMapSecName_Route32,
	[MAPSEC_ROUTE_33]                  = gMapSecName_Route33,
	[MAPSEC_ROUTE_34]                  = gMapSecName_Route34,
	[MAPSEC_ROUTE_35]                  = gMapSecName_Route35,
	[MAPSEC_ROUTE_36]                  = gMapSecName_Route36,
	[MAPSEC_ROUTE_37]                  = gMapSecName_Route37,
	[MAPSEC_ROUTE_38]                  = gMapSecName_Route38,
	[MAPSEC_ROUTE_39]                  = gMapSecName_Route39,
	[MAPSEC_ROUTE_40]                  = gMapSecName_Route40,
	[MAPSEC_ROUTE_41]                  = gMapSecName_Route41,
	[MAPSEC_ROUTE_42]                  = gMapSecName_Route42,
	[MAPSEC_ROUTE_43]                  = gMapSecName_Route43,
	[MAPSEC_ROUTE_44]                  = gMapSecName_Route44,
	[MAPSEC_ROUTE_45]                  = gMapSecName_Route45,
	[MAPSEC_ROUTE_46]                  = gMapSecName_Route46,
	[MAPSEC_ROUTE_47]                  = gMapSecName_Route47,
	[MAPSEC_ROUTE_48]                  = gMapSecName_Route48,
    [MAPSEC_DIGLETTS_CAVE_GS]          = gMapSecName_DiglettsCave,
    [MAPSEC_MT_MOON_GS]                = gMapSecName_MtMoon,
    [MAPSEC_ANCIENT_TOMB_GS]           = gMapSecName_AncientTomb,
    [MAPSEC_CERULEAN_CAVE_GS]          = gMapSecName_CeruleanCave,	
    [MAPSEC_ROCK_TUNNEL_GS]            = gMapSecName_RockTunnel,
    [MAPSEC_POWER_PLANT_GS]            = gMapSecName_PowerPlant,
    [MAPSEC_KANTO_SAFARI_ZONE_GS]      = gMapSecName_SafariZone,
    [MAPSEC_POKEMON_LEAGUE_GS]         = gMapSecName_PokemonLeague,
    [MAPSEC_SEAFOAM_ISLANDS_GS]        = gMapSecName_SeafoamIslands,
    [MAPSEC_ISLAND_CAVE_GS]            = gMapSecName_IslandCave,	
	[MAPSEC_SPROUT_TOWER]              = gMapSecName_SproutTower,
	[MAPSEC_TIN_TOWER]                 = gMapSecName_TinTower,
	[MAPSEC_BURNED_TOWER]              = gMapSecName_BurnedTower,
	[MAPSEC_NATIONAL_PARK]             = gMapSecName_NationalPark,
    [MAPSEC_RADIO_TOWER]               = gMapSecName_RadioTower,
    [MAPSEC_RUINS_OF_ALPH]             = gMapSecName_RuinsOfAlph,
    [MAPSEC_UNION_CAVE]                = gMapSecName_UnionCave,
    [MAPSEC_SLOWPOKE_WELL]  	       = gMapSecName_SlowpokeWell,
    [MAPSEC_LIGHTHOUSE]                = gMapSecName_Lighthouse,
    [MAPSEC_ROCKET_HQ]                 = gMapSecName_RocketHQ,
    [MAPSEC_ILEX_FOREST]               = gMapSecName_IlexForest,
    [MAPSEC_GOLDENROD_TUNNEL]          = gMapSecName_GoldenrodTunnel,
    [MAPSEC_MT_MORTAR]                 = gMapSecName_MtMortar,
    [MAPSEC_ICE_PATH]                  = gMapSecName_IcePath,
    [MAPSEC_WHIRL_ISLANDS]             = gMapSecName_WhirlIslands,	
    [MAPSEC_MT_SILVER_CAVE]            = gMapSecName_MtSilver,
    [MAPSEC_SILVER_RUINS]              = gMapSecName_SilverRuins,
    [MAPSEC_DARK_CAVE]                 = gMapSecName_DarkCave,
    [MAPSEC_KANTO_VICTORY_ROAD_GS]     = gMapSecName_VictoryRoad,	
    [MAPSEC_DRAGONS_DEN]               = gMapSecName_DragonsDen,
    [MAPSEC_TOHJO_FALLS]               = gMapSecName_TohjoFalls,
    [MAPSEC_VIRIDIAN_FOREST_GS]        = gMapSecName_ViridianForest,
    [MAPSEC_CONTEST_HALL]     		   = gMapSecName_ContestHall,
    [MAPSEC_S_S_AQUA]      		       = gMapSecName_SSAqua,
    [MAPSEC_TRAINER_HILL_GS]           = gMapSecName_TrainerHill,	
    [MAPSEC_CLIFF_CAVE] 			   = gMapSecName_CliffCave,    
	[MAPSEC_FRONTIER_ACCESS]           = gMapSecName_FrontierAccess,
	[MAPSEC_BATTLE_FRONTIER_GS]        = gMapSecName_BattleFrontier,
    [MAPSEC_BELLCHIME_TRAIL] 		   = gMapSecName_BellchimeTrail,
    [MAPSEC_SEALED_CHAMBER_GS]         = gMapSecName_SealedChamber,
    [MAPSEC_EMBEDDED_TOWER]		       = gMapSecName_EmbeddedTower,
    [MAPSEC_CLIFF_EDGE_GATE]           = gMapSecName_CliffEdgeGate,
    [MAPSEC_BIRTH_ISLAND_GS]           = gMapSecName_BirthIsland,
    [MAPSEC_FARAWAY_ISLAND_GS]         = gMapSecName_FarawayIsland,
    [MAPSEC_ARTISAN_CAVE_GS]           = gMapSecName_ArtisanCave,
    [MAPSEC_ALTERING_CAVE_GS]          = gMapSecName_AlteringCave,
    [MAPSEC_RADIO_TOWER_KANTO]         = gMapSecName_RadioTower,
    [MAPSEC_UNDERGROUND_PATH_GS]       = gMapSecName_UndergroundPath,
    [MAPSEC_SILPH_CO_GS]               = gMapSecName_SilphCo,
    [MAPSEC_SPECIAL_AREA_GS]           = gMapSecName_CeladonDept
};
...
u8 *GetMapName(u8 *dst0, u16 mapsec, u16 fill)
{
    ...
    else if (((idx = mapsec) < MAPSEC_NONE))
    {
...
u8 *GetMapNameNonGBA(u8 *dst0, u16 mapsec, u16 fill, u8 gameSwitch)
{
    u8 *str;
    u16 i;
    u16 idx;
	
	if (gameSwitch == 0 && (idx = mapsec) < MAPSEC_NONE_GS)
    {
        str = StringCopy(dst0, sJohtoMapNames[idx]);
    }		
	
    else if (gameSwitch == 1 && (idx = mapsec) <= MAPSEC_ORRE_E4)
    {
        str = StringCopy(dst0, sColosseumMapNames[idx]);
    }
    else if (gameSwitch == 2 && (idx = mapsec) <= MAPSEC_ORRE_E4)
    {
        str = StringCopy(dst0, sGaleOfDarknessMapNames[idx]);
    }
    else
    {
        if (fill == 0)
...
u8 *GetMapNameNonGBAGeneric(u8 *dest, u16 mapSec, u8 gameSwitch)
{
	if (gameSwitch > 0)
	{
		return GetMapNameNonGBA(dest, mapSec, 0, gameSwitch);
	}
	
	else
	switch (mapSec)
    {
    case MAPSEC_SPECIAL_AREA_GS:
        return StringCopy(dest, gMapSecName_CeladonDept);
    default:
        return GetMapNameNonGBA(dest, mapSec, 0, gameSwitch);
    }
}

// Unclear why this function is used over GetMapNameNonGBAGeneric
u8 *GetMapNameNonGBAGeneric_(u8 *dest, u16 mapSec, u8 gameSwitch)
{
	return GetMapNameNonGBAGeneric(dest, mapSec, gameSwitch);
}
