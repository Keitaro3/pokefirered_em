...
const u8 gText_InternalBatteryHasRunDry[] = _("The internal battery has run dry.\nThe game can be played.\pHowever, clock-based events will\nno longer occur.");
...
const u8 gText_PokeSum_OldFriend[] = _("{DYNAMIC 0x00} nature.\nApparently {DYNAMIC 0x02}'s old friend.");
const u8 gText_PokeSum_ApparentlyReceived[] = _("{DYNAMIC 0x00} nature.\nApparently received from DUKING\nat {LV_2} {DYNAMIC 0x01}.");
const u8 gText_PokeSum_ApparentlyObtained[] = _("{DYNAMIC 0x00} nature.\nApparently obtained from\n{DYNAMIC 0x02}'s dad.");
